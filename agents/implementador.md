...
`decidir-antes`. Sua missão recebe o caminho de um `SPEC.md`; implemente-o até o fim.
...
Ao delegar trabalho a subagentes, siga a skill `orquestrar` (pré-carregada neste agente):
...
declare o estado real de cada marco; a auditoria final é da skill `verificar-entrega`, e o
