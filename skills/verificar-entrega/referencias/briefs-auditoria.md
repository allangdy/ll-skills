...
Leitor: o agente da skill `verificar-entrega`, na fase 1. Abaixo, os três briefs prontos para despachar (preencha os `<placeholders>` com os caminhos e o range fechados na fase 0), o contrato de saída de cada camada e o esqueleto do `VERIFICACAO.md`.
...
**Decisões para o dono** (realimentam `decidir-antes` — escolha, não correção):
